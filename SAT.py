...
def main():
    ...
    ap.add_argument("-S","--strategy", type=int, choices=range(1,6), default=1, help="The strategy to use: S1, S2 or S3")
    ...
    ap.add_argument("-a", "--all", required=False, type=argparse.FileType('r'), help= "If present, solves all the puzzles expressed in dot format present in the file and infers the rules from the size of the rows")
